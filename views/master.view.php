<h2>Find the masters of certain trick in your region to consult</h2>
<form method="GET" action="master.php"> <!--refresh page when submitted-->
    <input type="hidden" id="NestedQueryRequest" name="NestedQueryRequest">
    <label for="trickName" class="col-form-label">Pick the trick you want to learn:</label> 
    ...
    <button type="submit" class="btn btn-primary" value="nestGroupsubmmit" name="nestGroupsubmmit">Submit</button>
</form>
...
<form method="GET" action="master.php"> <!--refresh page when submitted-->
    ...
    <label for="familiarity" class="col-form-label">Familiarity equal to (1-10):</label> 
...
<?php
    ...
    if (isset($_GET['joinQueryRequest']) || isset($_GET['NestedQueryRequest'])) {
        handleGETRequest();
    }